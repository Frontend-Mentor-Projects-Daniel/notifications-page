...
var $author$project$Main$notificationsDecoder = A8(
	...
	A2($elm$json$Json$Decode$field, 'privateMessage', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'otherPicture', $elm$json$Json$Decode$string));
var $author$project$Main$notificationsListDecoder = $elm$json$Json$Decode$list($author$project$Main$notificationsDecoder);
var $author$project$Main$getNotifications = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GetNotifications, $author$project$Main$notificationsListDecoder),
	...
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(' new notifications')
									]))
							])),
						A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('footer attribution center')
					]),
				_List_fromArray(
					[
