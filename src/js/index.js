	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$class('header center')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$class('main center')
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$class('footer attribution center')
					]),
				_List_fromArray(
					[
