...
var $dzuk_mutant$elm_html_styled_aria$Html$Styled$Attributes$Aria$ariaLive = $rtfeldman$elm_css$Html$Styled$Attributes$attribute('aria-live');
...
var $author$project$Main$createCss = function (styles) {
	return A2(
		$elm$core$List$map,
		function (prop) {
			return prop.val;
...
var $rtfeldman$elm_css$Css$marginBlockStart = $rtfeldman$elm_css$Css$prop1('margin-block-start');
var $author$project$Main$footerComponent = function () {
	var props = _List_fromArray(
		[
			{
			val: $rtfeldman$elm_css$Css$marginBlockStart($rtfeldman$elm_css$Css$auto)
		}
		]);
	return $author$project$Main$createCss(props);
}();
...
var $author$project$Main$headerComponent = function () {
	var props = _List_fromArray(
		[
			{val: $rtfeldman$elm_css$Css$displayFlex},
			{
			val: A2(
...
var $author$project$Main$markAsReadBtn = function () {
	var props = _List_fromArray(
		[
			{
			val: $rtfeldman$elm_css$Css$color(
				$rtfeldman$elm_css$Css$hex('#5E6778'))
		},
			{
			val: $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$transparent)
		},
			{
			val: $rtfeldman$elm_css$Css$border($rtfeldman$elm_css$Css$zero)
		},
			{
			val: $rtfeldman$elm_css$Css$cursor($rtfeldman$elm_css$Css$pointer)
		},
			{
			val: $rtfeldman$elm_css$Css$marginInlineStart($rtfeldman$elm_css$Css$auto)
		}
		]);
	return $author$project$Main$createCss(props);
}();
var $rtfeldman$elm_css$Css$fontSize = $rtfeldman$elm_css$Css$prop1('font-size');
var $author$project$Main$pxToRem = function (px) {
	return px / 16;
};
...
var $author$project$Main$notifications = function () {
	var props = _List_fromArray(
		[
			{
			val: $rtfeldman$elm_css$Css$fontSize(
				$rtfeldman$elm_css$Css$rem(
					$author$project$Main$pxToRem(20)))
		}
		]);
	return $author$project$Main$createCss(props);
}();
...
var $author$project$Main$notificationsNumber = function () {
	var props = _List_fromArray(
		[
			{
			val: $rtfeldman$elm_css$Css$color(
			...
			{
			val: $rtfeldman$elm_css$Css$backgroundColor(
				$rtfeldman$elm_css$Css$hex('#0A327B'))
		},
			{
			val: $rtfeldman$elm_css$Css$fontSize(
				$rtfeldman$elm_css$Css$rem(
					$author$project$Main$pxToRem(16)))
		},
			{
			val: $rtfeldman$elm_css$Css$fontWeight(
			...
			{
			val: $rtfeldman$elm_css$Css$borderRadius(
...
var $author$project$Main$rootComponent = function () {
	var props = _List_fromArray(
		[
			{val: $rtfeldman$elm_css$Css$displayFlex},
			{
			val: $rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column)
		}
		]);
	return $author$project$Main$createCss(props);
}();
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$id('root'),
				$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Main$rootComponent)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Main$headerComponent),
						$rtfeldman$elm_css$Html$Styled$Attributes$class('center flex-gap-9px')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Main$notifications)
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Notifications')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$span,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Main$notificationsNumber),
								$dzuk_mutant$elm_html_styled_aria$Html$Styled$Attributes$Aria$role('status'),
								$dzuk_mutant$elm_html_styled_aria$Html$Styled$Attributes$Aria$ariaLive('polite')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Main$markAsReadBtn)
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$class('center')
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$class('attribution center'),
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Main$footerComponent)
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Challenge by'),
						A2(
						$rtfeldman$elm_css$Html$Styled$a,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$href('https://www.frontendmentor.io?ref=challenge'),
								$rtfeldman$elm_css$Html$Styled$Attributes$target('_blank')
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(' Frontend Mentor. ')
							])),
						$rtfeldman$elm_css$Html$Styled$text('Coded by '),
						A2(
						$rtfeldman$elm_css$Html$Styled$a,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Daniel Arzanipour')
							]))
					]))
			]));
};
